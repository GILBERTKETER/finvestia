    ...
    <div class="content">
        ...
        <main style="height: fit-content;">
            ...
            <div class="header">
                ...
                <a href="mailto:info@finvestia.co.ke" class="report">
...
<div class="my-profile" id="my-profile2">
    ...
    <script>
        ...
        walletItem.addEventListener('click', function(event) {
            ...
            $no_OF_Refferals = "SELECT COUNT(*) AS REFFERALS_COUNT FROM profitedge_users AS refferer JOIN profitedge_users AS reffered_users ON refferer.User_Name = reffered_users.Refferer JOIN investments ON reffered_users.User_Name = investments.User_Name WHERE refferer.User_Name = ?";
...
?>
    ...
    <script>
        ...
        <h2>Invest With Gold Plan Today</h2>
            ...
            <div class="gold_Plan" >
                <div class="left_plan">
                    <p>When choosing the Gold Plan at the Plans tab, users will have access to a luxurious and exclusive investment opportunity. Investing with the Gold Plan is available in three flexible parts, with durations of 6 days, 14 days, and 21 days. Each part offers substantial returns, with rates of 30%, 50%, and 80% respectively, promising an excellent chance to grow their wealth. Don't miss out on this golden opportunity for high-yield investments!
                       </p>
                </div>
                ...
                <form action="" method="post" id="gold_Plan_form">
                    ...
                    <select name="gold_selectDays" id="gold_selectDays">
                        <option value="6">Six Days - 30%</option>
        ...
        <div class="planInvest" id="silver_Plan">
            ...
            <div class="silver_Plan" >
                ...
                <form action="" method="post" id="silver_Plan_form">
                    ...
                    <option value="6">Six Days - 20%</option>
                ...
                <p style="text-align:center; font-weight:bolder; font-size:.8rem;" id="bronzeResponseText"></p>
                    <form action="" method="post" id="bronze_Plan_form">
                        ...
                        <select name="bronze_selectDays" id="bronze_selectDays">
                            <option value="6">Six Days - 16%</option>
        ...
        `;
            ...
            function handleBronzeInvest(event) {
                ...
                const amount = parseFloat(amountInput.value);
                if (isNaN(amount) || amount < 500 || amount >= 2001) {
                    investmentResponse.textContent = "Bronze Investment must be greater than Ksh. 500 and less than or equal Ksh. 2000";
                    investmentResponse.style.color = "red";
                    return;
                }
                const xhr = new XMLHttpRequest();
